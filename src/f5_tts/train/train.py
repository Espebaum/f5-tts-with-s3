...
#-- 경로수정
# import os
# print("Changing working directory to: /home/gyopark/F5-TTS/bucket_data")
# os.chdir("/home/gyopark/F5-TTS/bucket_data")
...
def main(model_cfg):
    ...
    print("CFG", model_cfg.datasets.name)
    # train_dataset = load_dataset("/tmp/dataset", tokenizer, mel_spec_kwargs=model_cfg.model.mel_spec)
